...
| Tags  | [`SCRIPTS`](/categorize/tags/SCRIPTS.md) [`Jailbreak`](/categorize/tags/Jailbreak.md) [`Target`](/categorize/tags/Target.md) [`Hijack`](/categorize/tags/Hijack.md) [`Unpinning`](/categorize/tags/Unpinning.md) [`NFC`](/categorize/tags/NFC.md) [`Monitor`](/categorize/tags/Monitor.md) [`Discovery`](/categorize/tags/Discovery.md) [`Inject`](/categorize/tags/Inject.md) [`Bluetooth`](/categorize/tags/Bluetooth.md)                         |
| Langs | [`C++`](/categorize/langs/C++.md) [`Unknown`](/categorize/langs/Unknown.md) [`TypeScript`](/categorize/langs/TypeScript.md) [`Python`](/categorize/langs/Python.md) [`JavaScript`](/categorize/langs/JavaScript.md) [`Ruby`](/categorize/langs/Ruby.md) [`Shell`](/categorize/langs/Shell.md) [`Go`](/categorize/langs/Go.md) [`Java`](/categorize/langs/Java.md) [`Objective-C`](/categorize/langs/Objective-C.md) [`Meson`](/categorize/langs/Meson.md) [`Kotlin`](/categorize/langs/Kotlin.md) [`C`](/categorize/langs/C.md) [`Objective-C++`](/categorize/langs/Objective-C++.md)                        |
